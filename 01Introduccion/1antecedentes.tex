...
%            \caption{(izq.) imagen RGB, (centro) Mascara FG usando RGB, (der.) Mascara FG usando profundidad}%\cite{CompVisionKinect}} 
%            \label{fig:02Antecedentes}
%        \end{figure}
    ...
    \subsection{Mejorando la Clasificación y Detección de Objetos Basado en la Transformada de Hough y el Sensor Kinect}
        ...
        \begin{figure}[!htb]
            ...
            \caption[Técnica de preprocesamiento]{Técnica de preprocesamiento, (a) Imagen RGB, (b) Imagen de profundidad, (c) Imagen binaria, (d) Filtro Canny, y (e) Segmentación}% \cite{CompVisionKinecthough}} 
...
%            \caption{(izq.) Cilindro construido usando circulo y su normal, (der.) Cilindro construido con dos esferas y la línea que une sus centros.} 
%            \label{fig:05Antecedentes}
%        \end{figure}
